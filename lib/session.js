/* ======================================================================
   ...
   This is NOT a Coconut Hub token. The hub token obtained at sign-in is
   read once, on the server, and thrown away. What the browser gets is
   this: a small HMAC-signed blob naming who the reader is, useless
   against the hub or anything else.
